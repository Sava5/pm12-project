...
3. Создать ментальную карту по теме из индивидуального задания (Построение 3D-моделей и 3D-сцен в Blender по инструкциям).

### Пара №2. 12:20 - 13:05, 13:10 - 13:55

1. Созадть на своей web-странице новый файл 08.html(Ментальная карта).

2. Добавть в файл 08.html снимок экрана с результатом раобы, также опубликовать ссылку на Ментальную карту.
...
5. C:\Users\sava0\OneDrive\Изображения\Снимки экрана![Снимок экрана](images/screenshot.png)
