...
1. Составить и опубликовать план на 16 день практики.
   
2. Провести занятия на клавиатурном тренажере с английской и русской раскладками в течении 10 минут . 

3. Установить MS Office на личный ноутбук, для выполнения заданий VBA.

### Пара №2. 10:05 - 10:50, 10:55 - 11:40

1. Сделать некоторые элементы отчета.
2. сделать некоторые элементы приложения к отчету.
3. Посмотреть выступление товарища с зашитой отчета.
4. Учесть(исправить) допущенные ошибки товарищем.



### Пара №3. 12:20 - 13:05 13:10 - 13:55
1. Продолжить выполнять задания с  отчетом и приложением к отчету.
...
1. Составить и опубликовать план на 14 день практики.
   
2. Провести занятия на клавиатурном тренажере с английской и русской раскладками в течении 10 минут . 

3. Создать ментальную карту по теме из индивидуального задания (Построение 3D-моделей и 3D-сцен в Blender по инструкциям) с помощью сайта https://www.mindmeister.com/ru.

### Пара №2. 12:20 - 13:05, 13:10 - 13:55

1. Созадть на своей web-странице новый файл 08.html(Ментальная карта).

2. Добавить в файл 08.html снимок экрана с результатом работы, также опубликовать ссылку на Ментальную карту.

3. Опубликовать ссылку на Ментальную карту, на главной странице Web-сайта.

4. Добавть снимок экрана (Ментальная карта) в репозиторий: pm12-project. 

![Ментальная карта2](https://github.com/Sava5/pm12-project/assets/169751128/cc730031-7d1d-4824-8664-68e2c9803077)


### Пара №3. 14:05 - 14:50 14:55 - 15:40
1. **Индивидуальное задание**: В программе Blender создать модель городского многоэтажного жилого дома с помощью генерации
...
3.Создать в программе Blender анимацию, дождя и добавить ее в сцену: "Сцена с маяком".
